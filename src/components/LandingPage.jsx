    ...
    <div className="h-full">
      <div className="w-full container mx-auto">
        <div className="w-full flex items-center justify-between">
          <a class="flex items-center text-azure-400 no-underline hover:no-underline font-bold text-2xl lg:text-4xl" href="#">
            Coin<span class="bg-clip-text text-transparent bg-gradient-to-r from-green-400 via-azure-500 to-purple-500">.GPT</span>
          </a>
